...
export const WowRealms: Record<WowRegion, WowRealm[]> = {
  EU: [
  ...
  CN: [
    ...
    { name: '亚雷戈斯', slug: '亚雷戈斯' },
    { name: '亡语者', slug: '亡语者' },
    { name: '伊兰尼库斯', slug: '伊兰尼库斯' },
    { name: '伊利丹', slug: '伊利丹' },
    { name: '伊森利恩', slug: '伊森利恩' },
    { name: '伊森德雷', slug: '伊森德雷' },
    { name: '伊瑟拉', slug: '伊瑟拉' },
    { name: '伊莫塔尔', slug: '伊莫塔尔' },
    { name: '伊萨里奥斯', slug: '伊萨里奥斯' },
    { name: '元素之力', slug: '元素之力' },
    { name: '克尔苏加德', slug: '克尔苏加德' },
    { name: '克洛玛古斯', slug: '克洛玛古斯' },
    { name: '克苏恩', slug: '克苏恩' },
    { name: '兰娜瑟尔', slug: '兰娜瑟尔' },
    { name: '军团要塞', slug: '军团要塞' },
    { name: '冬寒', slug: '冬寒' },
    ...
    { name: '夺灵者', slug: '夺灵者' },
    { name: '奈法利安', slug: '奈法利安' },
    { name: '奎尔丹纳斯', slug: '奎尔丹纳斯' },
    { name: '奎尔萨拉斯', slug: '奎尔萨拉斯' },
    { name: '奥妮克希亚', slug: '奥妮克希亚' },
    { name: '奥尔加隆', slug: '奥尔加隆' },
    { name: '奥拉基尔', slug: '奥拉基尔' },
    { name: '奥斯里安', slug: '奥斯里安' },
    { name: '奥特兰克', slug: '奥特兰克' },
    ...
    { name: '布莱克摩', slug: '布莱克摩' },
    { name: '布莱恩', slug: '布莱恩' },
    { name: '布鲁塔卢斯', slug: '布鲁塔卢斯' },
    { name: '希尔瓦娜斯', slug: '希尔瓦娜斯' },
    { name: '希雷诺斯', slug: '希雷诺斯' },
    { name: '幽暗沼泽', slug: '幽暗沼泽' },
    { name: '库尔提拉斯', slug: '库尔提拉斯' },
    { name: '库德兰', slug: '库德兰' },
    { name: '弗塞雷迦', slug: '弗塞雷迦' },
    { name: '影之哀伤', slug: '影之哀伤' },
    { name: '影牙要塞', slug: '影牙要塞' },
    ...
    { name: '扎拉赞恩', slug: '扎拉赞恩' },
    { name: '托塞德林', slug: '托塞德林' },
    { name: '托尔巴拉德', slug: '托尔巴拉德' },
    { name: '拉文凯斯', slug: '拉文凯斯' },
    { name: '拉文霍德', slug: '拉文霍德' },
    { name: '拉格纳洛斯', slug: '拉格纳洛斯' },
    { name: '拉贾克斯', slug: '拉贾克斯' },
    { name: '提尔之手', slug: '提尔之手' },
    { name: '提瑞斯法', slug: '提瑞斯法' },
    { name: '摩摩尔', slug: '摩摩尔' },
    ...
    { name: '月光林地', slug: '月光林地' },
    { name: '月神殿', slug: '月神殿' },
    { name: '末日祷告祭坛', slug: '末日祷告祭坛' },
    { name: '末日行者', slug: '末日行者' },
    { name: '朵丹尼尔', slug: '朵丹尼尔' },
    { name: '杜隆坦', slug: '杜隆坦' },
    { name: '格瑞姆巴托', slug: '格瑞姆巴托' },
    { name: '格雷迈恩', slug: '格雷迈恩' },
    { name: '格鲁尔', slug: '格鲁尔' },
    { name: '桑德兰', slug: '桑德兰' },
    { name: '梅尔加尼', slug: '梅尔加尼' },
    ...
    { name: '玛里苟斯', slug: '玛里苟斯' },
    { name: '瑞文戴尔', slug: '瑞文戴尔' },
    { name: '瑟玛普拉格', slug: '瑟玛普拉格' },
    { name: '瑟莱德丝', slug: '瑟莱德丝' },
    { name: '瓦丝琪', slug: '瓦丝琪' },
    { name: '瓦拉斯塔兹', slug: '瓦拉斯塔兹' },
    { name: '瓦里玛萨斯', slug: '瓦里玛萨斯' },
    { name: '甜水绿洲', slug: '甜水绿洲' },
    { name: '生态船', slug: '生态船' },
    { name: '白银之手', slug: '白银之手' },
    { name: '白骨荒野', slug: '白骨荒野' },
    ...
    { name: '红龙军团', slug: '红龙军团' },
    { name: '红龙女王', slug: '红龙女王' },
    { name: '纳克萨玛斯', slug: '纳克萨玛斯' },
    { name: '纳沙塔尔', slug: '纳沙塔尔' },
    { name: '织亡者', slug: '织亡者' },
    { name: '维克尼拉斯', slug: '维克尼拉斯' },
    { name: '罗宁', slug: '罗宁' },
    { name: '罗曼斯', slug: '罗曼斯' },
    { name: '羽月', slug: '羽月' },
    { name: '翡翠梦境', slug: '翡翠梦境' },
