...
import { setExcludedBulkCharacters } from 'flux/analysis/reducer';
import { selectAnalysisExcludedBulk } from 'flux/analysis/selector';
...
export default function AnalysisFormExcluded() {
  const roster = useAppSelector(selectRosterInUseListWithWCLCharacter);
  const excluded = useAppSelector(selectAnalysisExcludedBulk);
