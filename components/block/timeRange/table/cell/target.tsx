...
import { setPriorityCharacters } from 'flux/customEbonMight/reducer';
import { selectCustomEbonMightPriorityByKey } from 'flux/customEbonMight/selector';
...
export default function TimeRangeTableCellTimeTarget({
  row,
  rowIndex,
  index,
  disabled = false,
  ...
  const priority = useAppSelector(selectCustomEbonMightPriorityByKey(key));
